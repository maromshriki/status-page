...
DATABASE = {
    ...
    'PASSWORD': 'msdwdatabase',           # PostgreSQL password
    'HOST': 'msdw-database-1.cx248m4we6k7.us-east-1.rds.amazonaws.com',      # Database server
...
REDIS = {
    'tasks': {
        'HOST': 'msdw-redis-7fftml.serverless.use1.cache.amazonaws.com:6379',
        'PORT': 6379,
